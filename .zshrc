...
export ZSH="/Users/sakshamsethi/.oh-my-zsh"

# Use "most" as the paging utility
export PAGER="most"
# Use "less" as BAT_PAGER to make git-delta work
export BAT_PAGER=/usr/local/bin/less
# MongoDB Setup
export config_type="mongo"
export CLUSTER_TYPE="local"
export config_host="local"
